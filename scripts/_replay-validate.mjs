...
const DESIGN_DST = "/Users/hengliheng/Easy-Email/public/test-assets/engagement_behavior4_template20_doubao-design.png";
const EMAIL_DIR = join(__dirname, `../data/emails/${EMAIL}`);
const OUT = join(EMAIL_DIR, 'layouts/default');

const PEXELS = {
  "hero-galaxy-note20-5g": "https://images.pexels.com/photos/30466756/pexels-photo-30466756.jpeg?auto=compress&cs=tinysrgb&h=350",
  "product-galaxy-s20-fe-5g": "https://images.pexels.com/photos/13780425/pexels-photo-13780425.jpeg?auto=compress&cs=tinysrgb&h=130",
  "product-galaxy-s20-plus-5g": "https://images.pexels.com/photos/34353879/pexels-photo-34353879.jpeg?auto=compress&cs=tinysrgb&h=130",
};

const ICON = {
  "category-phone": "https://cdn.jsdelivr.net/npm/@tabler/icons@3.31.0/icons/outline/device-mobile.svg",
  "category-tv": "https://cdn.jsdelivr.net/npm/@tabler/icons@3.31.0/icons/outline/device-tv.svg",
  "category-tablet-wearable": "https://cdn.jsdelivr.net/npm/@tabler/icons@3.31.0/icons/outline/device-tablet.svg",
  "category-computing": "https://cdn.jsdelivr.net/npm/@tabler/icons@3.31.0/icons/outline/device-laptop.svg",
  "category-appliance": "https://cdn.jsdelivr.net/npm/@tabler/icons@3.31.0/icons/outline/fridge.svg",
