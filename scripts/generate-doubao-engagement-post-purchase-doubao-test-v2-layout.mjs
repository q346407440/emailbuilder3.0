...
function productCell(id, imgSrc, title, idx) {
  return {
    ...
    children: [
      coverImage(`${id}-img`, imgSrc, `Product ${idx + 1} lifestyle`, '260px'),
  ...
  presets: {
    default: {
      ...
      tokens: {
        ...
        typography: { display: '48px', h1: '28px', body: '15px', caption: '13px' },
...
const meta = {
  schemaVersion: '1.0.0',
  displayName: '购买后 1豆包测试v2',
  description:
    '促销首屏、精选商品栅格、服务保障、页脚社媒。图源 Pexels，图标 jsDelivr。',
  source: 'human',
  ...
  variants: [
    {
      id: 'default',
      label: '默认版式',
      description: 'IMBŌDHI 购买后邮件 — 按设计图手工还原',
      publishStatus: 'published',
    },
  ],
};
