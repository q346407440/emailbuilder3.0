...
test("stripForbiddenWrapperFieldsFromBlock 剥离 layout 禁止字段", () => {
...
test("stripForbiddenWrapperFieldsFromBlock 保留 layout 双轴 contentAlign", () => {
...
test("stripForbiddenWrapperFieldsFromBlock 保留 text 双轴 contentAlign", () => {
  const block: EmailBlock = {
    id: "t1",
    type: "text",
    parentId: "root",
